import pandas as pd
from src.eda import plot_numerical_distributions, compute_numerical_summary, plot_categorical_distributions, compute_categorical_summary, plot_correlation_analysis
...
plot_correlation_analysis(df, num_feats)